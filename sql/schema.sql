...
CREATE TABLE eleicao.rede_social (
  ano               smallint NOT NULL,
  sq_candidato      bigint NOT NULL,
...
CREATE INDEX idx_rede_sq ON eleicao.rede_social (ano, sq_candidato);
CREATE INDEX idx_rede_url ON eleicao.rede_social USING gin (ds_url gin_trgm_ops);

CREATE TABLE eleicao.bem (
  ano               smallint NOT NULL,
  sq_candidato      bigint NOT NULL,
...
CREATE INDEX idx_bem_sq ON eleicao.bem (ano, sq_candidato);
